...
export default function ProductSchema({ product }) {
  const schema = {
    ...
    offers: { '@type': 'Offer', priceCurrency: 'USD', price: product.price, availability: product.stockStatus === false ? 'https://schema.org/OutOfStock' : 'https://schema.org/InStock', url: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://www.shelbycosmetic.com'}/products/${product.slug}` }
  }
