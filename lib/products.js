...
const makeProduct = ({
  ...
  images: [...images, ...imagePaths].slice(0, 3).map((image) => (typeof image === 'string' ? { url: image, alt: name } : image)),
  vendor,
  availability,
  soldCount,
  discountPercent,
...
const foundationProducts = [
  ...
  makeProduct({
    slug: 'emelie-paris-city-of-lights-pressed-foundation',
    name: 'emelie Paris Beauty The City of Lights Paris Long Lasting Pressed Foundation',
    price: 750,
    originalPrice: 1000,
    discountPercent: 25,
    category: 'Face',
    ...
    subcategory: 'Foundation',
    subcategorySlug: 'foundation',
    sku: 'EMELIE-CITY-LIGHTS',
    shortDescription: 'A long-lasting pressed foundation for an even, smooth and polished makeup base.',
    fullDescription: 'emelie Paris Beauty The City of Lights Paris Long Lasting Pressed Foundation offers convenient pressed coverage with a smooth, polished finish.',
    metaDescription: 'Shop emelie Paris The City of Lights Paris Long Lasting Pressed Foundation for smooth pressed coverage.'
  }),
  makeProduct({
...
const additionalProducts = [
  ...
  makeProduct({ slug: 'assorted-nail-polish-glamour', name: 'Assorted Nail Polish Glamour', price: 250, originalPrice: 320, discountPercent: 22, category: 'Nails', categorySlug: 'nails', subcategory: 'Polish Set', subcategorySlug: 'polish-set', sku: 'ASSORTED-NAIL-POLISH-GLAMOUR', shortDescription: 'A glamorous assorted nail polish selection.' }),
  makeProduct({ slug: 'cosmee-lemon-fruit-care-nail-polish-remover-wipes', name: 'Cosmee Lemon Fruit Care Nail Polish Remover Wipes', price: 225, originalPrice: 300, discountPercent: 25, category: 'Nails', categorySlug: 'nails', subcategory: 'Remover Wipes', subcategorySlug: 'remover-wipes', sku: 'COSMEE-LEMON-REMOVER-WIPES', shortDescription: 'Lemon fruit care wipes for quick nail polish removal.' }),
  makeProduct({ slug: 'bosuya-long-lasting-hairdressing-wand-black-01', name: 'Bosuya Long-Lasting Hairdressing Wand - 01# Black', price: 800, originalPrice: 1000, discountPercent: 20, category: 'Hair', categorySlug: 'hair', subcategory: 'Color Wand', subcategorySlug: 'color-wand', sku: 'BOSUYA-HAIR-WAND-01-BLACK', shortDescription: 'A long-lasting black hairdressing colour wand.' }),
  makeProduct({ slug: 'bosuya-long-lasting-hairdressing-wand-brownish-black-02', name: 'Bosuya Long-Lasting Hairdressing Wand - 02# Brownish Black', price: 800, originalPrice: 1000, discountPercent: 20, category: 'Hair', categorySlug: 'hair', subcategory: 'Color Wand', subcategorySlug: 'color-wand', sku: 'BOSUYA-HAIR-WAND-02-BROWNISH-BLACK', shortDescription: 'A long-lasting brownish black hairdressing colour wand.' }),
  makeProduct({ slug: 'bosuya-long-lasting-hairdressing-wand-coffee-03', name: 'Bosuya Long-Lasting Hairdressing Wand - 03# Coffee Color', price: 800, originalPrice: 1000, discountPercent: 20, category: 'Hair', categorySlug: 'hair', subcategory: 'Color Wand', subcategorySlug: 'color-wand', sku: 'BOSUYA-HAIR-WAND-03-COFFEE', shortDescription: 'A long-lasting coffee colour hairdressing wand.' }),
  ...
  makeProduct({ slug: 'battery-operated-eyebrow-trimmer-shaver-ladies', name: 'Battery Operated Eyebrow Trimmer Shaver For Ladies', price: 999, originalPrice: 1250, discountPercent: 20, category: 'Tools', categorySlug: 'tools', subcategory: 'Trimmer', subcategorySlug: 'trimmer', sku: 'BATTERY-EYEBROW-TRIMMER-LADIES', shortDescription: 'A battery-operated eyebrow trimmer for easy brow grooming.' }),
  makeProduct({ slug: 'ice-roller', name: 'Ice Roller', price: 650, originalPrice: 800, discountPercent: 19, category: 'Tools', categorySlug: 'tools', subcategory: 'Ice Roller', subcategorySlug: 'ice-roller', sku: 'ICE-ROLLER', shortDescription: 'A cooling ice roller for a refreshed skincare routine.' }),
  makeProduct({ slug: '5-piece-pink-mini-makeup-brush-set', name: '5-Piece Pink Mini Makeup Brush Set', price: 550, originalPrice: 700, discountPercent: 21, category: 'Tools', categorySlug: 'tools', subcategory: 'Brush Set', subcategorySlug: 'brush-set', sku: 'PINK-MINI-MAKEUP-BRUSH-5PCS', shortDescription: 'A five-piece pink mini makeup brush set for everyday application.' }),
  ...
  makeProduct({ slug: 'dodo-lady-matte-chocolate-brown-almond-press-on-nails', name: 'DoDo Lady Matte Chocolate Brown Almond Press-On Nails', price: 500, originalPrice: 650, discountPercent: 23, category: 'Nails', categorySlug: 'nails', subcategory: 'Press', subcategorySlug: 'press', sku: 'DODO-CHOCOLATE-BROWN-ALMOND', shortDescription: 'Matte chocolate brown almond-shaped press-on nails.' }),
  ...
  makeProduct({ slug: 'sadoer-lemon-extract-hydrate-soften-exfoliation-hand-mask', name: 'SADOER Lemon Extract Hydrate Soften Exfoliation Hand Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Hand Mask', subcategorySlug: 'hand-mask', sku: 'SADOER-LEMON-EXFOLIATION-HAND-MASK', shortDescription: 'A lemon extract hand mask for hydration and gentle exfoliation.' }),
  makeProduct({ slug: 'sadoer-coconut-extract-nourish-soften-exfoliation-hand-mask', name: 'SADOER Coconut Extract Nourish Soften Exfoliation Hand Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Hand Mask', subcategorySlug: 'hand-mask', sku: 'SADOER-COCONUT-EXFOLIATION-HAND-MASK', shortDescription: 'A coconut extract hand mask for nourishment and gentle exfoliation.' }),
  makeProduct({ slug: 'sadoer-strawberry-extract-moisture-soften-exfoliation-hand-mask', name: 'SADOER Strawberry Extract Moisture Soften Exfoliation Hand Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Hand Mask', subcategorySlug: 'hand-mask', sku: 'SADOER-STRAWBERRY-EXFOLIATION-HAND-MASK', shortDescription: 'A strawberry extract hand mask for moisture and gentle exfoliation.' }),
  ...
  makeProduct({ slug: 'sadoer-lemon-extract-hydrate-foot-mask', name: 'Sadoer Lemon Extract Hydrate Foot Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Foot Mask', subcategorySlug: 'foot-mask', sku: 'SADOER-LEMON-HYDRATE-FOOT-MASK', shortDescription: 'A hydrating lemon extract foot mask for refreshed feet.' }),
  makeProduct({ slug: 'sadoer-peach-extract-lustrous-soften-exfoliation-foot-mask', name: 'Sadoer Peach Extract Lustrous Soften Exfoliation Foot Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Foot Mask', subcategorySlug: 'foot-mask', sku: 'SADOER-PEACH-EXFOLIATION-FOOT-MASK', shortDescription: 'A peach extract foot mask for softening and gentle exfoliation.' }),
  makeProduct({ slug: 'sadoer-lemon-extract-hydrate-soften-exfoliation-foot-mask', name: 'SADOER Lemon Extract Hydrate Soften Exfoliation Foot Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Foot Mask', subcategorySlug: 'foot-mask', sku: 'SADOER-LEMON-EXFOLIATION-FOOT-MASK', shortDescription: 'A lemon extract foot mask for hydration and gentle exfoliation.' }),
  makeProduct({ slug: 'sadoer-coconut-extract-nourish-soften-exfoliation-foot-mask', name: 'SADOER Coconut Extract Nourish Soften Exfoliation Foot Mask', price: 350, originalPrice: 450, discountPercent: 22, category: 'Hand & Foot Care', categorySlug: 'hand-and-foot-care', subcategory: 'Foot Mask', subcategorySlug: 'foot-mask', sku: 'SADOER-COCONUT-EXFOLIATION-FOOT-MASK', shortDescription: 'A coconut extract foot mask for nourishment and gentle exfoliation.' }),
  makeProduct({
  ...
  makeProduct({
    ...
    images: [
      '/product%20images/YOZO%20Vitamin%20A%20Essence%20Anti-Acne%20Facial%20Mask%20Packet3.webp',
      '/product%20images/YOZO%20Vitamin%20A%20Essence%20Anti-Acne%20Facial%20Mask%20Packet1.webp',
      '/product%20images/YOZO%20Vitamin%20A%20Essence%20Anti-Acne%20Facial%20Mask%20Packet2.webp'
    ]
  }),
  makeProduct({
  ...
  makeProduct({
    slug: 'emelie-paris-dramatic-volume-mascara',
    name: 'emelie Paris Dramatic Volume Mascara',
    price: 550,
    originalPrice: 700,
    discountPercent: 21,
    category: 'Eyes',
    ...
    sku: 'EMELIE-DRAMATIC-VOLUME-MASCARA',
    shortDescription: 'A volumising mascara for bold, defined lashes.',
    fullDescription: 'emelie Paris Dramatic Volume Mascara helps build bold volume and definition for an expressive eye look.'
  }),
  makeProduct({
  ...
  makeProduct({
    ...
    name: 'HUXIA BEAUTY Shiny Glitter Lipgloss',
    price: 250,
    originalPrice: 350,
    discountPercent: 29,
    category: 'Lips',
    ...
    shortDescription: 'A shiny glitter lipgloss for a sparkling glossy finish.',
    fullDescription: 'HUXIA BEAUTY Shiny Glitter Lipgloss adds reflective sparkle and glossy shine to any lip look.',
    images: [
      '/product%20images/HUXIA%20BEAUTY%20Shiny%20Glitter%20Lipgloss%203.webp',
      '/product%20images/HUXIA%20BEAUTY%20Shiny%20Glitter%20Lipgloss%202.webp',
      '/product%20images/HUXIA%20BEAUTY%20Shiny%20Glitter%20Lipgloss%201.webp'
    ]
  }),
  makeProduct({
...
const allowedProductSlugs = new Set([
  ...
  'emelie-paris-city-of-lights-pressed-foundation',
  ...
  'bosuya-long-lasting-hairdressing-wand-brownish-black-02',
  'bosuya-long-lasting-hairdressing-wand-coffee-03',
  ...
  'sadoer-lemon-extract-hydrate-soften-exfoliation-hand-mask',
  'sadoer-coconut-extract-nourish-soften-exfoliation-hand-mask',
  'sadoer-strawberry-extract-moisture-soften-exfoliation-hand-mask',
  ...
  'sadoer-lemon-extract-hydrate-soften-exfoliation-foot-mask',
  'sadoer-coconut-extract-nourish-soften-exfoliation-foot-mask',
  ...
  'emelie-paris-dramatic-volume-mascara',
