...
const additionalProducts = [
  makeProduct({ slug: 'bob-fashion-color-nail-polish', name: 'BOB Fashion Color Nail Polish 6 Pcs Set', price: 1400, originalPrice: 320, discountPercent: 22, category: 'Nails', categorySlug: 'nails', subcategory: 'Polish Set', subcategorySlug: 'polish-set', sku: 'BOB-FASHION-COLOR-NAIL-POLISH', shortDescription: 'A fashionable nail polish set for a smooth, colourful finish.', images: [
  ...
  makeProduct({ slug: 'mode-love-matte-nail-polish', name: 'Mode Love Matte Nail Polish 6 Pcs Set', price: 1400, originalPrice: 320, discountPercent: 22, category: 'Nails', categorySlug: 'nails', subcategory: 'Polish Set', subcategorySlug: 'polish-set', sku: 'MODE-LOVE-MATTE-NAIL-POLISH', shortDescription: 'A matte nail polish set with a smooth, modern finish.', images: [
  ...
  makeProduct({ slug: 'assorted-nail-polish-glamour', name: 'Assorted Nail Polish Glamour 6 Pcs Set', price: 1400, originalPrice: 320, discountPercent: 22, category: 'Nails', categorySlug: 'nails', subcategory: 'Polish Set', subcategorySlug: 'polish-set', sku: 'ASSORTED-NAIL-POLISH-GLAMOUR', shortDescription: 'A glamorous assorted nail polish set.', images: [
  ...
  makeProduct({ slug: 'meow-club-10-min-painless-body-wax-powder-orange', name: 'Meow Club 10 Min Painless Body Wax Powder - Orange', price: 999, originalPrice: 1800, discountPercent: 17, category: 'Hair Removal', categorySlug: 'hair-removal', subcategory: 'Wax Powder', subcategorySlug: 'wax-powder', sku: 'MEOW-CLUB-WAX-POWDER-ORANGE', shortDescription: 'An orange body wax powder designed for a quick hair removal routine.', images: [
